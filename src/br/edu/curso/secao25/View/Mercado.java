package br.edu.curso.secao25.View;
            ...
            for(Produto p : Mercado.produtos){
                if(p.getCodigo() == codigo){
                    ...
                    try{
                        ...
                        //Já tem este produto no carrinho, só atualiza a quantidade
                ...
                if(tem){
                    ...
                    System.out.println("Não foi encontado o produto no código " + codigo);
                    Utils.pausar(2);
                    Mercado.menu();
                }
            }
